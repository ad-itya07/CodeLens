        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative" style={{ background: '#080C10' }}>
            ...
            >
                <div className="text-center space-y-2">
                    ...
                    <h2 className="text-3xl font-bold tracking-tight text-[#E6EDF3]">Welcome back</h2>
                    <p className="text-[#8B949E]">Log in to your CodeLens account</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-sm font-medium text-[#8B949E]">Password</label>
                            </div>
                            <div className="relative">
                        ...
                        <motion.button
                            type="submit"
                            disabled={loading}
                            className="w-full gradient-btn text-white font-semibold py-3 rounded-xl transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
